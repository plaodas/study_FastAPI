...
def upgrade():
    ...
    op.add_column(
        "item_audit", sa.Column("user_id", sa.String(length=128), nullable=True)
    )
    op.add_column("item_audit", sa.Column("ip", sa.String(length=45), nullable=True))
    op.add_column(
        "item_audit", sa.Column("method", sa.String(length=16), nullable=True)
    )
    op.add_column("item_audit", sa.Column("user_agent", sa.Text(), nullable=True))
    op.add_column(
        "item_audit", sa.Column("request_path", sa.String(length=512), nullable=True)
    )
